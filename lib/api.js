...
const API_URL = process.env.NEXT_PUBLIC_EKKLESIA_API_URL || 'http://localhost:4000';
...
export const attendeesApi = {
  ...
  importDuplicates: (eventId, duplicates) => api.post(`/events/${eventId}/attendees/import-duplicates`, { duplicates }),
